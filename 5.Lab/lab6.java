...
class Link
{
public int data; public Link nextLink; public Link(int d)
{
...
try
{
BufferedReader br=new BufferedReader(new InputStreamReader(System.in)); System.out.println("Enter the element");
int ele=Integer.parseInt(br.readLine());
 
Link link = new Link(ele); link.nextLink = first;
first = link;
}
catch(IOException e)
{
...
{
Link currentLink = first; System.out.print("Elements are: "); while(currentLink != null)
{
...
do
{
System.out.println("1.Push 2.Pop 3.Display 4.Exit 5.Use Linked List"); System.out.println("Enter your choice:"); ch=Integer.parseInt(br.readLine());
switch(ch)
{
case 1:
stk.push(); break;
...
while(ch<5);
System.out.println("Implementation of Stack using Linked List"); Stack_List stk1=new Stack_List();
ch=0; do
{
